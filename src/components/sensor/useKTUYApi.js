...
export function useKTUYApi() {
    ...
    async function getThingData(thingLink) {
        const { response, error } = await withAsync(api.get, thingLink);
    ...
    async function getSensorData(sensorLink) {
        const { response, error } = await withAsync(api.get, sensorLink);
    ...
    async function getSensorObservations(observationsLink) {
        ...
        const { response, error } = await withAsync(api.get, observationsLink, {
            params,
